...
const STARTER: Draft = {
  title: "ACADEMY PLAYTEST — CHALLENGE 2 ROLL CALL",
  questions: [
    {
      id: q(),
      type: "multiple",
      text: "What day are we on in Challenge 2?",
      options: ["11", "12", "13", "14"],
      correct: 2,
      timeLimit: 10,
      doublePoints: false,
    },
    {
      id: q(),
      type: "multiple",
      text: "Who did Aldi Taher wish a happy birthday to?",
      options: ["Mila", "Dimas", "Ryan", "Farid"],
      correct: 2,
      timeLimit: 10,
      doublePoints: false,
    },
    {
      id: q(),
      type: "multiple",
      text: "Who appeared in the GA Concept Testing session?",
      options: ["Zozo Buttercup", "Mila Blossom", "Dea Blossom", "Nadya Bubbles"],
      correct: 2,
      timeLimit: 10,
      doublePoints: false,
    },
    {
      id: q(),
      type: "multiple",
      text: "What does HIG stand for?",
      options: [
        "Human Interfacing Guidelines",
        "Human Interaction Guidelines",
        "Human Interface Guidelines",
        "Human Interactivity Guidelines",
      ],
      correct: 2,
      timeLimit: 10,
      doublePoints: false,
    },
    {
      id: q(),
      type: "multiple",
      text: "Which of these elements is liquid at standard room temperature (20–25°C)?",
    ...
    },
    {
      id: q(),
      type: "multiple",
      text: "When will we start the next bridge?",
      options: ["June 1", "June 2", "June 3", "June 4"],
      correct: 1,
      timeLimit: 10,
      doublePoints: false,
    },
    {
      id: q(),
      type: "multiple",
      text: "What is the mentor's correct full name?",
      options: ["Dimas Maulari", "Dimas Maulana", "Farid Azizah", "Anita Mande Tamala"],
      correct: 1,
      timeLimit: 10,
      doublePoints: false,
    },
    {
      id: q(),
      type: "multiple",
      text: "Who is the Head of Academy?",
      options: ["Farid", "Peter", "Ryan", "Zozo"],
      correct: 2,
      timeLimit: 10,
      doublePoints: false,
    },
    {
      id: q(),
      type: "multiple",
      text: "What is the big idea behind this challenge?",
      options: ["Daily Struggles", "Daily Motivation", "Daily Annoyances", "Daily Activity"],
      correct: 2,
      timeLimit: 10,
      doublePoints: false,
    },
    {
      id: q(),
      type: "truefalse",
      text: "Are you guys ready for today's session???",
      options: ["YESSSIRRRRR", "Nope (noted 👀)"],
      correct: 0,
      timeLimit: 10,
      doublePoints: false,
    },
