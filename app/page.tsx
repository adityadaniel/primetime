...
export default function HomePage() {
  return (
    <main className="relative min-h-screen overflow-hidden grain">
          ...
          >
            <div className="col-span-12 md:col-span-6">
              <p className="font-editorial text-2xl md:text-3xl leading-[1.18] max-w-[640px]">
                A real-time quiz <em>broadcast</em> for classrooms, conference rooms, and the back
                of any room with a projector. You are the producer, the room is the audience, the
                answers are tabulated <em>live</em>.
              </p>
            </div>
      ...
      <section className="relative px-8 pb-16">
        <div className="max-w-[1240px] mx-auto grid grid-cols-12 gap-6">
          ...
          >
            ...
            <p className="display-num mt-6" style={{ fontSize: 'clamp(56px, 9vw, 132px)' }}>
              GO LIVE
            </p>
        ...
        >
          ...
          <p className="font-editorial italic max-w-md">
            Distinguishable by shape, not just color — keep the four answer channels readable for
      ...
      <footer
        className="px-8 pb-8 max-w-[1240px] mx-auto flex items-end justify-between border-t-2 pt-4"
        style={{ borderColor: 'var(--ink)' }}
      >
        <span className="ticker text-[11px] tracking-widest opacity-60">
          © BROADCAST NETWORK · STUDIO 4 · TRANSMISSION 0001
        </span>
        <span className="font-editorial italic opacity-60">"Roll tape."</span>
      </footer>
    </main>
  );
}
